<template>
  <div>
    ...
    <wangyiarticlesave ref="save" :form="editinfo" ></wangyiarticlesave>
...
<script type="text/ecmascript-6">
  ...
  import wangyiarticlesave from './save.vue'
...
//      });
    ...
    methods: {
      getData() {
        ...
        this.apiGet('sys/wangyiArticle', data).then((data) => {
      ...
      getArticle(index){
        ...
        this.apiGet('sys/wangyiArticleOne/' + editid).then((res) => {
          this.handelResponse(res, (data, msg) => {
            this.editinfo = data
          }, (data, msg) => {
            this.$Message.error(msg);
