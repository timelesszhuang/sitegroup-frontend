...
//           }
...

          {
            ...
            render(h, params) {
              ...
              if(params.row.scrapystatus == '20')
              {
                scrapystatusbutton = h('Button', {
                  props: {
                    size: 'small'
                  },
                  style: {
                  ...
                  on: {
                    click: function () {
                      _this.scrapyStatus(params.index,'10')
                    }
                  }
                }, '正常爬取')
              }else{
                scrapystatusbutton = h('Button', {
                  ...
                  on: {
                    click: function () {
                      _this.scrapyStatus(params.index,'20')
                    }
                  }
                }, '停止爬取')
              }
