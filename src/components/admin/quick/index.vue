<template>
  <div>
    <div class="top" style="padding-left: 10px">
      快捷添加单页:
      <Input v-model="name" placeholder="单页名称" style="width:300px;"></Input>
    ...
    <codeadd ref="add"></codeadd>
    <codesave ref="save" :form="editinfo"></codesave>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.apiGet('code', data).then((data) => {
