<template>
  <div>
    <div>
      <Modal
        v-model="modal" width="1300" style="height:auto">
        <p slot="header">
          <span>添加配置</span>
        </p>
        <div>
          <Form ref="customeform" :model="form" :label-width="90" :rules="AddRule" class="node-add-form">
            ...
            <Row>
              <Col span="6">
              <Form-item label="分类名称" style="width: 300px;" prop="name1">
                <Input type="text" v-model="form.field1.name" placeholder="请输入名称"></Input>
              </Form-item>
              </Col>
              <Col span="6">
              <Form-item label="placeholder" style="width: 300px;" prop="placeholder1">
                <Input type="text" v-model="form.field1.placeholder" placeholder="请输入placeholder配置"></Input>
              </Form-item>
              </Col>
              <Col span="6">
              <Form-item label="type类型" style="width: 300px;" prop="type1">
                <Select v-model="form.field1.type" clearable style="width:200px">
                  <Option v-for="item in type" :value="item.value" :key="item.value">{{ item.label }}</Option>
                </Select>
              </Form-item>
              </Col>
              <Col span="6">
              <Form-item label="是否必填" style="width: 300px;" prop="require">
            ...
            <Row>
              <Col span="6">
              <Form-item label="分类名称2" style="width: 300px;" prop="name2">
                <Input type="text" v-model="form.field2.name" placeholder="请输入名称"></Input>
              </Form-item>
              </Col>
              <Col span="6">
              <Form-item label="placeholder2" style="width: 300px;" prop="placeholder2">
                <Input type="text" v-model="form.field2.placeholder" placeholder="请输入placeholder配置"></Input>
              </Form-item>
              </Col>
              <Col span="6">
              <Form-item label="type类型2" style="width: 300px;" prop="type2">
                <Select v-model="form.field2.type" clearable style="width:200px">
                  <Option v-for="item in type" :value="item.value" :key="item.value">{{ item.label }}</Option>
                </Select>
              </Form-item>
              </Col>
            ...
            <Row>
              <Col span="6">
              <Form-item label="分类名称3" style="width: 300px;" prop="name2">
                <Input type="text" v-model="form.field3.name" placeholder="请输入名称"></Input>
              </Form-item>
              </Col>
              <Col span="6">
              <Form-item label="placeholder3" style="width: 300px;" prop="placeholder2">
                <Input type="text" v-model="form.field3.placeholder" placeholder="请输入placeholder配置"></Input>
              </Form-item>
              </Col>
              <Col span="6">
              <Form-item label="type类型3" style="width: 300px;" prop="type2">
                <Select v-model="form.field3.type" clearable style="width:200px">
                  <Option v-for="item in type" :value="item.value" :key="item.value">{{ item.label }}</Option>
                </Select>
              </Form-item>
              </Col>
            ...
            <Row>
              <Col span="6">
              <Form-item label="分类名称4" style="width: 300px;" prop="name2">
                <Input type="text" v-model="form.field4.name" placeholder="请输入名称"></Input>
              </Form-item>
              </Col>
              <Col span="6">
              <Form-item label="placeholder4" style="width: 300px;" prop="placeholder2">
                <Input type="text" v-model="form.field4.placeholder" placeholder="请输入placeholder配置"></Input>
              </Form-item>
              </Col>
              <Col span="6">
              <Form-item label="type类型4" style="width: 300px;" prop="type2">
                <Select v-model="form.field4.type" clearable style="width:200px">
                  <Option v-for="item in type" :value="item.value" :key="item.value">{{ item.label }}</Option>
                </Select>
              </Form-item>
              </Col>
