          ...
          <Form ref="customesave" :model="form" :label-width="90" :rules="AddRule" class="node-add-form">
            ...
            <Row>
              ...
              <Form-item label="type类型" style="width: 300px;" prop="type1">
                <Select v-model="field1.type" clearable style="width:200px">
            ...
            <Row>
              ...
              <Form-item label="type类型2" style="width: 300px;" prop="type2">
                <Select v-model="field2.type" clearable style="width:200px">
                  <Option v-for="item in type" :value="item.value" :key="item.value">{{ item.label }}</Option>
                </Select>
              </Form-item>
              </Col>
            ...
            <Row>
              ...
              <Form-item label="type类型3" style="width: 300px;" prop="type2">
                <Select v-model="field3.type" clearable style="width:200px">
                  <Option v-for="item in type" :value="item.value" :key="item.value">{{ item.label }}</Option>
                </Select>
              </Form-item>
              </Col>
            ...
            <Row>
              ...
              <Form-item label="type类型4" style="width: 300px;" prop="type2">
                <Select v-model="field4.type" clearable style="width:200px">
                  <Option v-for="item in type" :value="item.value" :key="item.value">{{ item.label }}</Option>
                </Select>
              </Form-item>
              </Col>
